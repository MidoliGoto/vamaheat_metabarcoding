...
A phyloseq object is usually composed by an ASV table, a taxonomy table and 
...
```{r}
phyloseq::get_sample(physeq, i = "70920f490e5af8c263db656e98c426b9dc03f370")
```

* **Show ASVs and abundance for a given sample**
```{r}
phyloseq::get_taxa(physeq, i = "S_F002_B") |> head()
```
...
saveRDS(physeq, file = "/home/midoli/Documents/RESULTS_SEQUENCAGE_METABARCOD_nicolas/course-material-main/data/asv_table/mon_objet_phyloseq.rds")
